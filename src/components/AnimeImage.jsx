...
export const AnimeImage = () => {
  ...
  return (
    <div className="ml-[230px] mt-[10px]">
      <div className="flex">
        <img src="https://www.animefillerlist.com/sites/default/files/styles/anime_poster/public/screenshot_2021-04-19_naruto-shippuden-1131_webp_webp_image_350_x_525_pixels_0.png?itok=dpibYojN" />
      </div>
